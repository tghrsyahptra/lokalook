package com.lokalook.lokalook.mycamera
...
import com.data.api.ApiConfig
import com.data.api.FileUploadResponse
import com.lokalook.lokalook.mycamera.getImageUri
import com.lokalook.lokalook.mycamera.uriToFile
import com.google.gson.Gson
import com.lokalook.lokalook.R
import com.lokalook.lokalook.databinding.ActivityMyCameraBinding
import com.lokalook.lokalook.mycamera.CameraActivity.Companion.CAMERAX_RESULT
                ...
                try {
                    ...
                    with(successResponse.data) {
                        if (isAboveThreshold == true) {
                            ...
                            val intent = Intent(this@MyCamera, ResultActivity::class.java).apply {
                            ...
                            showToast("Confidence score is too low.")
                        }
                    }
                    showLoading(false)
