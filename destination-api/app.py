...
destination_labels = {
    'Alun Alun Purwokerto': 0,
    'Curug': 1,
    'Menara Pandang Teratai': 2,
    'Menggala Ranch': 3,
    'Taman Botani Baturraden': 4,
    'Taman Mas Kemambang': 5,
    'The Village Purwokerto': 6
}
...
try:
    model = load_model_from_gcs('lokalook-ds', 'exception_destination_100final.tflite')
